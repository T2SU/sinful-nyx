...
namespace Sevens.Effects
{
    public class SpineAnimationPlayer : MonoBehaviour
    {
        ...
        {
            yield return new Speeches.Dialogue("안녕0", null, "그래0");
            yield return new Speeches.Dialogue("안녕1", null, "그래1");
            yield return new Speeches.Dialogue("안녕2", null, "그래2");
            yield return new Speeches.Dialogue("안녕3", null, "그래3");
            yield return new Speeches.Dialogue("안녕4", null, "그래4");
        }
    }
}
