...
public class _SceneManagement : MonoBehaviour
{
    private static _SceneManagement instance;
    public static _SceneManagement Instance {
        get {
            if(!instance) {
                instance = new GameObject("SceneManagement", typeof(_SceneManagement)).GetComponent<_SceneManagement>();
    ...
    private void SceneManager_sceneLoaded(Scene arg0, LoadSceneMode arg1)
    {
        ...
        if (gameCamera == null)
        {
            Instantiate(Resources.Load("GameCamera"));
        }

        var destroyManager = GameObject.Find("DestroyManager");
        if (destroyManager == null)
        {
            Instantiate(Resources.Load("DestroyManager"));
        }
