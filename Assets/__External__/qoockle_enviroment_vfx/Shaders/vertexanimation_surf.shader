Shader "qoockle/enviroment/vertexanimation_surf"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 uv_VertexAnimationMask8 = v.texcoord;
			float3 ase_vertexNormal = v.normal.xyz;
			float mulTime9 = _Time.y * _TimePeriodScale;
			v.vertex.xyz += ( ( 1.0 - tex2Dlod( _VertexAnimationMask, half4( uv_VertexAnimationMask8, 0, 0.0) ).r ) * ase_vertexNormal * _VertexOffsetPower * sin( mulTime9 ) );
		}
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( i.vertexColor * tex2DNode15 ).rgb;
			o.Alpha = ( i.vertexColor.a * tex2DNode15.a );
		}
